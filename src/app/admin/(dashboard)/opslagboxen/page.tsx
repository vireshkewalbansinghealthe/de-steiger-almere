...
export default function AdminOpslagboxenPage() {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        const response = await fetch('/api/properties?type=opslagbox&limit=100')
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Opslagboxen</h1>
            <p className="mt-2 text-gray-600">Beheer alle opslagboxen</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0 sm:space-x-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Zoek op naam of box nummer..."
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <span className="text-sm text-slate-700">
                {selectedProperties.length} opslagbox{selectedProperties.length !== 1 ? 'en' : ''} geselecteerd
              </span>
            </div>
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg">
              ...
              <tr key={property.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <div className="flex items-center justify-end space-x-2">
                    <Link
                      href={`/opslagbox/opslagbox-type-${property.type_number}`}
        ...
        {filteredProperties.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">Geen opslagboxen gevonden</h3>
            <p className="mt-1 text-sm text-gray-500">
              Pas je zoekfilters aan of voeg een nieuwe opslagbox toe.
            </p>
          </div>
        )}
      </div>
